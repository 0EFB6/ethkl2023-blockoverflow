...
export default function Header({account, generateAccount}) {
    return (
        <header className="bg-gray-800 text-white flex justify-between items-center px-8 py-4 border-b-2 border-cyan-300">
            ...
            <nav>
                <ul className="flex space-x-8">
                    ...
                    <button className="bg-black border-2 border-cyan-300 rounded-full py-1 px-3 hover:border-cyan-500" onClick={generateAccount}>
                    {account
